...
class _ResultControlTaskPanel:
    ...
    def vm_stress_selected(self, state):
        ...
        QApplication.setOverrideCursor(Qt.WaitCursor)
        self.MeshObject.ViewObject.setNodeColorByStress(self.result_object)
    ...
    def select_displacement_type(self, disp_type):
        ...
        self.MeshObject.ViewObject.setNodeColorByDisplacement(self.result_object, match[disp_type])
